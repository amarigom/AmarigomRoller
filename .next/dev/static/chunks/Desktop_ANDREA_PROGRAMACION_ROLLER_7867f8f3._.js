    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$ANDREA$2f$PROGRAMACION$2f$ROLLER$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "InventarioPage.useEffect": ()=>{
            ...
            fetch("/api/inventory").then({
                "InventarioPage.useEffect": (res)=>res.json()
            }["InventarioPage.useEffect"]).then({
                "InventarioPage.useEffect": (data)=>{
                    console.log("Datos recibidos de la API:", data); // <--- ESTO ES CLAVE
                    setRolls(data);
                    setLoading(false);
                }
            }["InventarioPage.useEffect"]).catch({
                "InventarioPage.useEffect": (err)=>{
...
_s(InventarioPage, "08BHXLtYxfN45RFW8RIQp1vhq8k=");
_c = InventarioPage;
var _c;
...
//# sourceMappingURL=Desktop_ANDREA_PROGRAMACION_ROLLER_7867f8f3._.js.map